...
import br.com.digidev.domain.Authority;
import br.com.digidev.domain.User;
import br.com.digidev.repository.AuthorityRepository;
...
import br.com.digidev.service.util.RandomUtil;
import br.com.digidev.service.dto.UserDTO;
...
public class UserService {
    ...
    /**
     * Retorna se o registro eh ou nao do usuario
     * @param userId id do usuario do registro
     * @return true  para eh do usuario ou false para nao eh
     */
    public boolean isUserEntity(Long userId){
        return userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin()).get().getId().equals(userId);
    }
}
